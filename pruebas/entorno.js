...
function arrancar() {
  ...
  ['js/config.js', 'js/registro.js', 'js/sabotaje.js', 'js/arte.js', 'js/mapa.js',
   'js/codigo.js', 'js/retos.js', 'js/pistas-datos.js', 'js/pistas.js', 'js/juego.js'].forEach(function (f) {
